...
//				transform.position = hit.point + 1 * -camFollow.transform.forward;
				transform.position = Vector3.Lerp(transform.position, hit.point +1 * -camFollow.transform.forward, 1.4f * Time.deltaTime);
			}
			else {
				transform.position = Vector3.Lerp(transform.position,camFollow.transform.position, 1.4f * Time.deltaTime);
...
//				transform.position = Vector3.MoveTowards(transform.position, camFollow.transform.position, 5 * Time.deltaTime);
		...
		transform.position = Vector3.Lerp(transform.position, camSpot.transform.position,1.4 * Time.deltaTime);
	}
}